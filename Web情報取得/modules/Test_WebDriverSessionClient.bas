...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでActionInnerText一致要素をClickする(ByVal Assert As UnitTestAssert)
    ...
    Dim operation As TransitionOperation
    Set operation = New_TransitionOperation("OpenList", ".menu-button", ActionInnerText:="一覧 を 開く", Script:="fallback()", WaitConditionName:="ListReady")
...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでActionInnerText一致0件ならScriptFallbackしない(ByVal Assert As UnitTestAssert)
    ...
    Dim operation As TransitionOperation
    Set operation = New_TransitionOperation("OpenList", ".menu-button", ActionInnerText:="一覧を開く", Script:="fallback()", WaitConditionName:="ListReady")
...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでActionInnerTextは文字種を区別する(ByVal Assert As UnitTestAssert)
    ...
    Dim operation As TransitionOperation
    Set operation = New_TransitionOperation("OpenList", ".menu-button", ActionInnerText:="abc ア あ", WaitConditionName:="ListReady")
...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでActionInnerText対象がStaleなら再探索する(ByVal Assert As UnitTestAssert)
    ...
    Dim operation As TransitionOperation
    Set operation = New_TransitionOperation("OpenList", ".menu-button", ActionInnerText:="一覧を開く", WaitConditionName:="ListReady")
...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでFrame内ActionInnerText一致要素をClickする(ByVal Assert As UnitTestAssert)
    ...
    Dim operation As TransitionOperation
    Set operation = New_TransitionOperation("OpenDetail", "iframe[name='right'] >> .menu-button", ActionInnerText:="詳細を開く", WaitConditionName:="DetailReady")
