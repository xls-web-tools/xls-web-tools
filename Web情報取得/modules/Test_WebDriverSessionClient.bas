...
Public Sub Test_WebDriverSessionClient_DownloadLinkedFile_tmpファイルは完了扱いしない(ByVal Assert As UnitTestAssert)
    On Error Resume Next
    ...
    Call fs_stub.Store.SetReturn("GetFileList", empty_files, "C:\Temp\xls-web-tools_tmp123.tmp", "\.(crdownload|tmp)$", "", True)

    Dim tmp_files(0 To 0) As String
    tmp_files(0) = "C:\Temp\xls-web-tools_tmp123.tmp\ABCD.tmp"
    Call fs_stub.Store.SetReturn("GetFileList", tmp_files, "C:\Temp\xls-web-tools_tmp123.tmp", "", "\.crdownload$", True)
