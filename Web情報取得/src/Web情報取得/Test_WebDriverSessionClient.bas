...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationChainで各操作後にWaitSelectorを待機する(ByVal Assert As UnitTestAssert)
    On Error Resume Next
...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでActionInnerText一致要素をClickする(ByVal Assert As UnitTestAssert)
    On Error Resume Next
    ...
    Dim operation As TransitionOperation
    Set operation = New_TransitionOperation("OpenList", ".menu-button", ActionInnerText:="一覧 を 開く", ActionScript:="fallback()", WaitSelector:="#list-ready")
...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでActionInnerText一致0件ならScriptFallbackしない(ByVal Assert As UnitTestAssert)
    On Error Resume Next
    ...
    Dim operation As TransitionOperation
    Set operation = New_TransitionOperation("OpenList", ".menu-button", ActionInnerText:="一覧を開く", ActionScript:="fallback()", WaitSelector:="#list-ready")
    ...
    Assert.IsTrue 0 < InStr(1, Err.Description, "ActionInnerText=一覧を開く", vbBinaryCompare)
    Assert.IsTrue 0 < InStr(1, Err.Description, "MatchCount=0", vbBinaryCompare)
    Assert.EqualsNumeric 0, client_double.Store.GetCallCount("Execute", "POST", "/session/abc/execute/sync", fallback_script_body)
End Sub

Public Sub Test_WebDriverSessionClient_RunTransitionOperationでActionInnerText一致複数件ならScriptFallbackしない(ByVal Assert As UnitTestAssert)
    On Error Resume Next
...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでActionInnerTextは文字種を区別する(ByVal Assert As UnitTestAssert)
    On Error Resume Next
    ...
    Dim operation As TransitionOperation
    Set operation = New_TransitionOperation("OpenList", ".menu-button", ActionInnerText:="abc ア あ", WaitSelector:="#list-ready")
...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでActionInnerText対象がStaleなら再探索する(ByVal Assert As UnitTestAssert)
    On Error Resume Next
    ...
    Dim operation As TransitionOperation
    Set operation = New_TransitionOperation("OpenList", ".menu-button", ActionInnerText:="一覧を開く", WaitSelector:="#list-ready")
...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでFrame内ActionInnerText一致要素をClickする(ByVal Assert As UnitTestAssert)
    On Error Resume Next
    ...
    Dim operation As TransitionOperation
    Set operation = New_TransitionOperation("OpenDetail", "iframe[name='right'] >> .menu-button", ActionInnerText:="詳細を開く", WaitSelector:="#target-id")
...
Public Sub Test_WebDriverSessionClient_RunTransitionOperationでActionInnerText確定後Click失敗ならScriptFallbackする(ByVal Assert As UnitTestAssert)
    On Error Resume Next
